...
public class EstudianteRepository {
    ...
    public Estudiante actualizarEstudiante(Long id, Estudiante nuevoEstudiante, Estudiante antiguoEstudiante) {
        nuevoEstudiante.setId(id);
        estudiantes.replace(id, antiguoEstudiante, nuevoEstudiante);
